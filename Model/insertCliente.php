...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    function inserirRegistro($conexao, $nome, $email, $senha) {
        ...
        $sql_verifica = "SELECT COUNT(*) AS total FROM cliente WHERE email = :email";
    ...
    $userId = inserirRegistro($conexao, $nome, $email, $senha);
    if ($userId !== false) {
    ...
    // Email já cadastrado
    echo "
    <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../View/html/cadastroCliente.php'>
    <script type=\"text/javascript\">
